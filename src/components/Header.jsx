...
export default function Header() {
  ...
  const manejarClick = (e) => {
    e.preventDefault(); // Evita que el enlace haga una acción por defecto (navegar)
    setMostrarModal(prevState => !prevState); // Cambia el estado a 'true' para mostrar el modal
  };
    ...
    <header className="bg-white">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="" onClick={manejarClick} className="text-sm/6 font-semibold text-gray-900">
