...
export default function Example() {
  return (
    ...
    <div className={styles.parent}>
      <div className={`${styles.div1} text-base/10 font-semibold text-gray-900`}>Formulario de Registro para Solicitar una Beca</div>
      <div className={`${styles.div2}`}>
      <form className='bg-red-50' >
      <div className="space-y-12">
        <div className="flex-row border-b border-gray-900/10 pb-12">
          <h2 className="justify-start text-base/7 font-semibold text-gray-900">Datos Personales</h2>
